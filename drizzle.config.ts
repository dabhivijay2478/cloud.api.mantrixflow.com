...
export default {
  schema: [
    ...
    './src/database/schemas/billing/dodo-subscriptions.schema.ts',
    './src/database/schemas/billing/dodo-subscription-events.schema.ts',
    './src/database/schemas/billing/dodo-customers.schema.ts',
