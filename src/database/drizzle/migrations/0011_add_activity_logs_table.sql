...
-- This migration creates the activity_logs table for centralized audit logging
-- All organization-scoped activities are logged here for audit and monitoring purposes
